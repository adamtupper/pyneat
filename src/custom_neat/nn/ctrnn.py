...
class CTRNN(object):
    ...
    @staticmethod
    def create(genome, time_constant):
        """ Receives a genome and returns its phenotype (a CTRNN). """
        required = required_for_output(genome.inputs, genome.outputs,
        ...
        return CTRNN(genome.inputs, genome.outputs, node_evals)
